...
static struct pinmux_config common_gpio_pin_mux[] = {
    ...
    {"emu0.gpio3_7",OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT_PULLUP, GPIO_TO_PIN(3, 7), GPIOF_OUT_INIT_LOW, "sync_mode"},
    ...
    //{"gpmc_a4.gpio1_20",OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT_PULLUP,GPIO_TO_PIN(1, 20),GPIOF_OUT_INIT_LOW, "sync_mode"},
